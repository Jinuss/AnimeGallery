...
第三元素是描述人物气质的美好词汇，**每张图片必须不同，禁止在同一个 JSON 文件内重复**。

按人物类型选择词汇风格：

| 类型 | 词汇方向 | 示例 |
|------|----------|------|
| 女性角色 | 容貌、气质、姿态 | 仙姿玉色、绝代佳人、清雅脱俗、明眸善睐、娉婷袅娜、温婉如玉、秀外慧中 |
| 男性角色 | 气度、志向、风骨 | 意气风发、英姿飒爽、气宇轩昂、锋芒毕露、坚毅如铁、沉稳内敛、仙风道骨 |
| 情侣/双人 | 适配关系 | 璧人 |
| 场景 | 气象、格局 | 恢宏磅礴、气象万千 |

**关键约束：** 同一个 JSON 文件内，每条数据的第三元素必须唯一不重复。生成前先扫描已有词汇，避开已使用的。
